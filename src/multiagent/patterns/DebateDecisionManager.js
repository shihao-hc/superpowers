...
class Debater {
  ...
  async argue(_context, _debateHistory, _state) {
...
`.trim();
  ...
  async argue(context, debateHistory, _state) {
...
class Judge {
  ...
  async decide(bullArgument, bearArgument, context, _state) {
