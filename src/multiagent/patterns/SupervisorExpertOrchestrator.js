...
class Supervisor {
  ...
  async _runExpertsConcurrently(context, state, _options = {}) {
  ...
  async _aggregateResults(results, _context, _state) {
    ...
    const aggregated = {
      ...
      recommendations: this._generateRecommendations(successfulResults, _context)
    };
  ...
  _generateRecommendations(results, _context) {
