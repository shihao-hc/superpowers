...
const { Supervisor, Expert, createExpert: _createExpert } = require('../patterns/SupervisorExpertOrchestrator');
const { DebateManager, BullDebater: _BullDebater, BearDebater: _BearDebater, Judge: _Judge } = require('../patterns/DebateDecisionManager');
const { createLLMAdapter: _createLLMAdapter } = require('../patterns/BaseLLMAdapter');
...
class SecurityExpert extends Expert {
  async analyze(context, _state) {
    const { code, language: _language } = context;
