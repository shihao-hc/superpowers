...
console.log('\n1️⃣ 模块导入检查');
try {
  const _GameAgent = require('../src/agents/GameAgent');
  const _TaskPlanner = require('../src/game/TaskPlanner');
  const _GameEventHandler = require('../src/game/GameEventHandler');
  const _GameManager = require('../src/game/GameManager');
